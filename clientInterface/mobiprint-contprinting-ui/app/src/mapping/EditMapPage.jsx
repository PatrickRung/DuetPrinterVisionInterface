...
const EditMapPage = (props) => {
    ...
    const { data: robotStatus, isLoading: robotStatusLoading } = useRobotStatusQuery();
    ...
    return <EditMap rawMap={mapData} theme={theme} mode={props.mode} helpText={helpText} robotStatus={robotStatus} enqueueSnackbar={enqueueSnackbar} supportedCapabilities={{
