 ...
 */
export const IterationsIcon = ({ iterationCount }) => {
    return (<svg width="26" height="26" fill="currentColor" version="1.1" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
